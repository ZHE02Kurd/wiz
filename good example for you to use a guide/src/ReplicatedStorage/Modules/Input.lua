...
if not initialized then
	...
	-- Add default Backpack5 keybind if it doesn't exist (BEFORE processing keybinds!)
	if not keybinds:FindFirstChild("Backpack5") then
		local backpack5 = Instance.new("StringValue")
		backpack5.Name = "Backpack5"
		backpack5.Value = "KeyCode.Five" -- Use full format for consistency
		backpack5.Parent = keybinds
		print("[INPUT] Added default Backpack5 keybind")
	end

	repeat -- (This is around line 194)
		RunService.Stepped:wait()
